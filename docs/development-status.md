# Caspilot — Engineering Status Log

> This is the detailed, phase-by-phase build log (formerly the project `README.md`).
> For the project overview, pitch, and quickstart, see the root [`README.md`](../README.md).
> The mandatory **Tier-1 on-chain demo** with block-explorer-verifiable proof lives in [`tier1-demo.md`](tier1-demo.md).

The authoritative design is `docs/superpowers/specs/2026-06-05-caspilot-design.md`; the phased build lives in `docs/superpowers/plans/2026-06-05-caspilot-implementation.md`.
